...
[**Full guide**](docs/GUIDE.md) — what every room means, which files are read, the HTTP API, privacy, FAQ.
[Contributing](CONTRIBUTING.md) · [Changelog](CHANGELOG.md)

## Credits

Character sprites: [MetroCity pack](https://jik-a-4.itch.io/metrocity-free-topdown-character-pack) by JIK-A-4 (CC0).
Furniture sprites: [Pixel Agents](https://github.com/pixel-agents-hq/pixel-agents) by Pablo De Lucca (MIT) — see [LICENSE-THIRD-PARTY.md](LICENSE-THIRD-PARTY.md).
